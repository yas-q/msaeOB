#' @title Sample Data for Multivariate Small Area Estimation with Optimum Benchmarking
#'
#' @description Dataset to simulate optimum benchmarking of Multivariate Fay-Herriot model
#'
...
#'   \item Then combine the direct estimations \code{Y1 Y2 Y3}, explanatory variables \code{X1 X2}, weight \code{w1 w2 w3}, and sampling varians covarians \code{v1 v12 v13 v2 v23 v3} in a dataframe then named as datamsaeOB
#' }
#'
